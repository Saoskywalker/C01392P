...
// 文件名称 : GCE_Data_Type.h
// 功能描述 : 数据类型定义
// 作    者 :
// 创建日期 : 2021.5.13
// 版    本 : V0.0.1
// 变更记录 : V0.0.1/2021.5.13/
//            1.首次创建
//******************************************************************************
...
//                                 macro definitions
//******************************************************************************
#ifndef _GCE_DATATYPE_H_
#define _GCE_DATATYPE_H_
...
typedef enum {Disable = 0, Enable = 0x1} TYPE_FUNCEN;
